...
const content = {
  es: {
    ...
    info: {
      ...
      opsAddr: "ESTADO ANZOATEGUI MCPIO. SAN JOSE DE GUANIPA PARR. SAN JOSE DE GUANIPA 6054 ZONA INDUSTRIAL CALLE ALEJANDRO PETION AV MARIÑO C/C CA JACINTO LARA SERCOGRAM, C.A 2",
      phones: "TELÉFONOS",
